use smithay::{
    desktop::Space, desktop::Window, input::pointer::AxisFrame, input::pointer::ButtonEvent,
    input::pointer::GestureHoldBeginEvent, input::pointer::GestureHoldEndEvent,
    input::pointer::GesturePinchBeginEvent, input::pointer::GesturePinchEndEvent,
    input::pointer::GesturePinchUpdateEvent, input::pointer::GestureSwipeBeginEvent,
    input::pointer::GestureSwipeEndEvent, input::pointer::GestureSwipeUpdateEvent,
    input::pointer::GrabStartData as PointerGrabStartData, input::pointer::MotionEvent,
    input::pointer::PointerGrab, input::pointer::PointerInnerHandle,
    input::pointer::RelativeMotionEvent,
    reexports::wayland_protocols::xdg::shell::server::xdg_toplevel,
    reexports::wayland_server::protocol::wl_surface::WlSurface, utils::Logical, utils::Point,
    utils::Rectangle, utils::Size, wayland::compositor, wayland::shell::xdg::SurfaceCachedState,
};
